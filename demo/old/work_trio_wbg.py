...
# resouce dir, aux data for plotting...
resdir = Path('../resources')
bgfile = resdir / 'gamma3_res2.tif'
...
# output
odir = Path('.')
oname = 'tseries_ch4_1min_conc_co_trio_wbg.mp4'
...
bga = pu.background_adder(bgfile)
